...
<br><br><br><br><br>
	...
	<br><br>
	<h10>&nbsp;&nbsp;Sign Up&nbsp;&nbsp;</h10>
        <h5><p>Please fill this form to create an account.</p></h5>
        <form id ="form", action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
          <h6>  <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Username</label><br>
                <input type="text" name="username" class="form-control" value="<?php echo $username; ?>">
                <span class="help-block"><?php echo $username_err; ?></span>
            </div>
	  </h6>    
	  <h6>  <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                <label>Email</label><br>
                <input type="text" name="email" class="form-control" value="<?php echo $email; ?>">
                <span class="help-block"><?php echo $email_err; ?></span>
            </div>
	  </h6>   
	  <h6>  <div class="form-group <?php echo (!empty($phone_err)) ? 'has-error' : ''; ?>">
                <label>Phone Number</label><br>
                <input type="text" name="phone" class="form-control" value="<?php echo $phone; ?>">
                <span class="help-block"><?php echo $phone_err; ?></span>
            </div>   
          </h6>  
	  <h6>	<div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
